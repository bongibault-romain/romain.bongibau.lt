---
title: "De la Compilation à l'Exécution : Conception d'un Système Complet (Compilateur + Processeur)"
description: "Découvrez comment nous avons conçu un compilateur de A à Z, du langage haut niveau à l'exécution sur un processeur avec pipeline. Un projet complet en informatique."
...
<Image width="1190" height="722" alt="Schéma d'architecture" caption="Fig. 1 - Schéma d'architecture montrant les 4 blocs (compilateur → assembleur mémoire → registre → exécution)" src="/images/projects/compilateur-cross-compilateur-pipeline/architecture.png" />
...
<Image width="1652" height="610" alt="Architecture de notre processeur" caption="Fig. 2 - Architecture de notre processeur, sans gestion des conflits" src="/images/projects/compilateur-cross-compilateur-pipeline/pipeline.png" />
...
Vous pouvez retrouver le code source complet de ce projet sur notre [GitHub](https://github.com/bongibault-romain/systeme-informatique)