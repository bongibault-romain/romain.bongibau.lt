...
*AJOUTER IMAGE : un visuel du campus de l'INSA Toulouse, ou une interaction stylisée entre un étudiant et un assistant IA.*
...
*AJOUTER IMAGE : schéma de l'architecture de scraping (exploration, extraction, stockage).*
...
*AJOUTER IMAGE : tableau de performances des modèles Scratch (page 4).*
...
*AJOUTER IMAGE : pipeline RAG, étape par étape (voir page 6 du papier).*
...
*AJOUTER IMAGE : capture d'écran de l'interface IAN (voir page 7).*
