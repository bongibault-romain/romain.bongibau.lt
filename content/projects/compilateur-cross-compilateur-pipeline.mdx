...
<Image alt="Schéma d'architecture" caption="Fig. 1 - Schéma d'architecture montrant les 4 blocs (compilateur → assembleur mémoire → registre → exécution)" src="/images/projects/compilateur-cross-compilateur-pipeline/architecture.png" />
...
<Image alt="Architecture de notre processeur" caption="Fig. 2 - Architecture de notre processeur, sans gestion des conflits" src="/images/projects/compilateur-cross-compilateur-pipeline/pipeline.png" />
